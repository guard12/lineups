...
export default function CreateGame() {
  ...
  return (
    ...
    <div className="flex flex-col gap-4">
      ...
      <Input id="name" placeholder="🍺 Beer competition" className="mt-2" value={gameName} onChange={(e) => setGameName(e.target.value)} />
      </div>
      <div>
      <Label>Home team name</Label>
      <Input id="name" placeholder="Rusty Nutcrackers" className="mt-2" value={homeTeam} onChange={(e) => setHomeTeam(e.target.value)} />
      </div>
      <div>
      <Label>Away team name</Label>
      <Input id="name" placeholder="Gray old boys" className="mt-2" value={awayTeam} onChange={(e) => setAwayTeam(e.target.value)} />
      </div>
